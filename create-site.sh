...
mkdir -p assets/css assets/js assets/images thoughts
...
<head>
    ...
    <title>Vivek Roy - Thoughts</title>
        ...
        <div class="terminal-content">
            ...
            <div class="output">
                <div class="file-line">
                    ...
                    <a href="thoughts/the-manager-and-the-machine.html" class="file-link">The Manager and The Machine</a>
                </div>
                <div class="file-line">
                    <span class="file-number">02. </span>
                    <a href="thoughts/refinement-in-place.html" class="file-link">Refinement in Place</a>
                </div>
                <div class="file-line">
                    <span class="file-number">03. </span>
                    <a href="thoughts/proof-over-persuasion.html" class="file-link">Proof over Persuasion</a>
                </div>
                <div class="file-line">
                    <span class="file-number">04. </span>
                    <a href="thoughts/code-highest-resolution.html" class="file-link">Code Is the Highest-Resolution Expression of Intelligence</a>
                </div>
                <div class="file-line">
                    <span class="file-number">05. </span>
                    <a href="thoughts/work-charts-not-org-charts.html" class="file-link">Work Charts, Not Org Charts</a>
                </div>
                <div class="file-line">
                    <span class="file-number">06. </span>
                    <a href="thoughts/reflection-as-training-signal.html" class="file-link">Reflection as a Training Signal</a>
                </div>
            </div>
            <div class="command-line mt-4">
                <span class="prompt">vivekroyeng@github:~/thoughts$</span>
            ...
            <div class="output">
                ...
                some thoughts study the technical<br/>
...
# Thought Template
# ============================================
cat > thoughts/essay-template.html << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
# Thought 1
# ============================================
cat > thoughts/the-manager-and-the-machine.html << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
echo "✓ Created thoughts/the-manager-and-the-machine.html"

# ============================================
# Thought 2
# ============================================
cat > thoughts/refinement-in-place.html << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
echo "✓ Created thoughts/refinement-in-place.html"

# ============================================
# Thought 3
# ============================================
cat > thoughts/proof-over-persuasion.html << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
echo "✓ Created thoughts/proof-over-persuasion.html"

# ============================================
# Thought 4
# ============================================
cat > thoughts/code-highest-resolution.html << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
echo "✓ Created thoughts/code-highest-resolution.html"

# ============================================
# Thought 5
# ============================================
cat > thoughts/work-charts-not-org-charts.html << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
echo "✓ Created thoughts/work-charts-not-org-charts.html"

# ============================================
# Thought 6
# ============================================
cat > thoughts/reflection-as-training-signal.html << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
echo "✓ Created thoughts/reflection-as-training-signal.html"
